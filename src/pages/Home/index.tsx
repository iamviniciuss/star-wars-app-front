...
const user = {
  ...
  imageUrl:
    'https://www.fotoefeitos.com/images/202109/01/fotoefeitos.com__final_1480036530360780018_.jpg?act=91',
}
const navigation = [
                                    ...
                                    <div className="vacation-card">
                                        <div className="vacation-card-info">
                                            ...
                                            <div className="vacation-card-eyebrow">
                                                <p className="text-sm">Luke Skywalker</p>
                                            </div>
                                            <div className="vacation-card-title">
                                                <a href="/vacations/cancun"></a>
                                            </div>
                                            </div>
                                        </div>
                                    </div>
